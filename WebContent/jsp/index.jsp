...
<body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="index.jsp">Log In</a></li>
        </ul>
      </div>
    </div>
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1><font color="#3A5795"><b>Login:</b></font></h1><br>
  <form method="post" action="login.jsp">
    ...
    <input type="submit" name="login" class="login login-submit" value="LOGIN">
       ...
       <h3><a href="reg.jsp"> Register ||</a>  <a href="adminlogin.jsp">Administrative Login ||</a> <a href="doctorlogin.jsp">Doctors Login</a></h3>
