...
<body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="doctorlogin.jsp">Doctors Log In</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
         <h1><font color="#3A5795"><b>Doctors Login:</b></font></h1><br>
  <form method="post" action="doctordatalogin.jsp">
    User Name:<br>
