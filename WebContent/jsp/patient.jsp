    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="patient.jsp">Patient</a></li>
...
%>
      ...
      <div id="content">
        ...
        <h1 align="left"><font color="blue"><b>Patient Information:</b></font></h1>
          <% 
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/name","root","123@pass");

            Statement statement = connection.createStatement() ;
            ResultSet resultset = 
                statement.executeQuery("select * from patient") ; 
            //table is patient
        %>
